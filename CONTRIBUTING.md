# Contributing to fatarrow-ascii-art
...
## Issues
If you find a bug in the source code or a mistake in the documentation, you can help by submitting an [issue](https://github.com/CaryLandholt/fatarrow-ascii-art/issues) to the repository.  Even better, you can submit a [Pull Request](#pull-requests) with a fix.

Before you submit your issue, search the [archive](https://github.com/CaryLandholt/fatarrow-ascii-art/issues).  Maybe your question was already answered.
...
* Search for an open or closed [Pull Request](https://github.com/CaryLandholt/fatarrow-ascii-art/pulls) that relates to your submission.  You don't want to duplicate effort.
...
```
* Send a pull request to `fatarrow-ascii-art:master`
